...
/*----------------------------------------------------------------------------------------------------------------------*/
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'description' => __( 'Choose option to show/hide slider control at homepage.', 'uniform' ),
            'section' => 'uniform_slider_section',
            'choices' => array(
    ...
    $wp_customize->add_setting(
        ...
        array(
            'default' =>'show',
            'sanitize_callback' => 'uniform_sanitize_slider_pager',
        )
    );
    $wp_customize->add_control(
        'slider_pager_option',
        array(
            'type' => 'radio',
            'priority'    => 5,
            'label' => __( 'Slider Pager', 'uniform' ),
            'description' => __( 'Choose option to show/hide slider pager at homepage.', 'uniform' ),
            'section' => 'uniform_slider_section',
            'choices' => array(
                'show'     => __( 'Show', 'uniform' ),
                'hide'   => __( 'Hide', 'uniform' ),
...
/*----------------------------------------------------------------------------------------------------------------------*/
    ...
    $wp_customize->add_setting(
        ...
        array(
            'default' =>'show',
            'sanitize_callback' => 'uniform_sanitize_cta',
        )
    );
    $wp_customize->add_control(
        'call_to_action_option',
...
/*----------------------------------------------------------------------------------------------------------------------*/
    ...
    $wp_customize->add_control(
        ...
        array(
            'type' => 'radio',
            'priority'    => 6,
            'label' => __( 'Post Meta Control', 'uniform' ),
            'description' => __( 'Choose option to show/hide post meta of posts in Latest blog section', 'uniform' ),
            'section' => 'uniform_latest_blog_section',
            'choices' => array(
                'show'     => __( 'Show', 'uniform' ),
                'hide'   => __( 'Hide', 'uniform' ),
