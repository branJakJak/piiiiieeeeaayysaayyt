        ...
        <div class="mt-container">
            <div class="mt-column-wrapper clearfix">
                ...
                <div class="about-wrapper mt-column-2 <?php echo esc_attr( $section_side ); ?>">
                    ...
                    ?>
                        <h2 class="section-title about-us"><a href="<?php the_title();?>"><?php the_title(); ?></a></h2>
                        <div class="page-thumb">
                            <?php if( has_post_thumbnail() ) { ?>
                                <figure><img src="<?php echo esc_url( $image_path[0] );?>" alt="<?php the_title();?>" title="<?php the_title();?>" /></figure>
                            <?php } ?>
                        </div>
